...
if ($shieldclimbcryptogateway_eth_conversion_resp && isset($shieldclimbcryptogateway_eth_conversion_resp['value_coin'])) {
    ...
    return null;
		...
		$shieldclimbcryptogateway_eth_feesest_response = wp_remote_get('https://api.shieldclimb.com/crypto/eth/fees.php', array('timeout' => 30));
...
$shieldclimbcryptogateway_eth_response_minimum = wp_remote_get('https://api.shieldclimb.com/crypto/eth/info.php', array('timeout' => 30));
