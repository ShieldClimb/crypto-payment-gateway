...
if ($shieldclimbcryptogateway_linkoptimism_conversion_resp && isset($shieldclimbcryptogateway_linkoptimism_conversion_resp['value_coin'])) {
    ...
    return null;
		...
		$shieldclimbcryptogateway_linkoptimism_feesest_response = wp_remote_get('https://api.shieldclimb.com/crypto/optimism/link/fees.php', array('timeout' => 30));
...
$shieldclimbcryptogateway_linkoptimism_response_minimum = wp_remote_get('https://api.shieldclimb.com/crypto/optimism/link/info.php', array('timeout' => 30));
