...
if ($shieldclimbcryptogateway_dogebep20_conversion_resp && isset($shieldclimbcryptogateway_dogebep20_conversion_resp['value_coin'])) {
    ...
    return null;
		...
		$shieldclimbcryptogateway_dogebep20_feesest_response = wp_remote_get('https://api.shieldclimb.com/crypto/bep20/doge/fees.php', array('timeout' => 30));
...
$shieldclimbcryptogateway_dogebep20_response_minimum = wp_remote_get('https://api.shieldclimb.com/crypto/bep20/doge/info.php', array('timeout' => 30));
