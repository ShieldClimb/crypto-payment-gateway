...
if ($shieldclimbcryptogateway_daibep20_conversion_resp && isset($shieldclimbcryptogateway_daibep20_conversion_resp['value_coin'])) {
    ...
    return null;
		...
		$shieldclimbcryptogateway_daibep20_feesest_response = wp_remote_get('https://api.shieldclimb.com/crypto/bep20/dai/fees.php', array('timeout' => 30));
...
$shieldclimbcryptogateway_daibep20_response_minimum = wp_remote_get('https://api.shieldclimb.com/crypto/bep20/dai/info.php', array('timeout' => 30));
