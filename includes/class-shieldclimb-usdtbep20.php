...
if ($shieldclimbcryptogateway_usdtbep20_conversion_resp && isset($shieldclimbcryptogateway_usdtbep20_conversion_resp['value_coin'])) {
    ...
    return null;
		...
		$shieldclimbcryptogateway_usdtbep20_feesest_response = wp_remote_get('https://api.shieldclimb.com/crypto/bep20/usdt/fees.php', array('timeout' => 30));
...
$shieldclimbcryptogateway_usdtbep20_response_minimum = wp_remote_get('https://api.shieldclimb.com/crypto/bep20/usdt/info.php', array('timeout' => 30));
