...
if ($shieldclimbcryptogateway_bch_conversion_resp && isset($shieldclimbcryptogateway_bch_conversion_resp['value_coin'])) {
    ...
    return null;
		...
		$shieldclimbcryptogateway_bch_feesest_response = wp_remote_get('https://api.shieldclimb.com/crypto/bch/fees.php', array('timeout' => 30));
...
$shieldclimbcryptogateway_bch_response_minimum = wp_remote_get('https://api.shieldclimb.com/crypto/bch/info.php', array('timeout' => 30));
