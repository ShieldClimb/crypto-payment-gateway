...
if ($shieldclimbcryptogateway_eurcsol_conversion_resp && isset($shieldclimbcryptogateway_eurcsol_conversion_resp['value_coin'])) {
    ...
    return null;
		...
		$shieldclimbcryptogateway_eurcsol_feesest_response = wp_remote_get('https://api.shieldclimb.com/crypto/sol/eurc/fees.php', array('timeout' => 30));
...
$shieldclimbcryptogateway_eurcsol_response_minimum = wp_remote_get('https://api.shieldclimb.com/crypto/sol/eurc/info.php', array('timeout' => 30));
