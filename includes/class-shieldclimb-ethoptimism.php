...
if ($shieldclimbcryptogateway_ethoptimism_conversion_resp && isset($shieldclimbcryptogateway_ethoptimism_conversion_resp['value_coin'])) {
    ...
    return null;
		...
		$shieldclimbcryptogateway_ethoptimism_feesest_response = wp_remote_get('https://api.shieldclimb.com/crypto/optimism/eth/fees.php', array('timeout' => 30));
...
$shieldclimbcryptogateway_ethoptimism_response_minimum = wp_remote_get('https://api.shieldclimb.com/crypto/optimism/eth/info.php', array('timeout' => 30));
